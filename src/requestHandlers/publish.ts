...
const _publishController = (sequelize : Sequelize) => async (author_id: string, 
    ...
    try {
        ...
        const image1Id = `${author_id}_${panelImage1.originalname}_${panel_set.id}`;
        const image2Id = `${author_id}_${panelImage2.originalname}_${panel_set.id}`;
        const image3Id = `${author_id}_${panelImage3.originalname}_${panel_set.id}`;
        ...
        await hooks.forEach(async(hook) =>{
            ...
            const createdHook =  await createHook(sequelize, t)({
